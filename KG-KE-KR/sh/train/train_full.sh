...
/research/king3/wchen/Anaconda3/envs/py3.6_th0.4.1_cuda9.0/bin/python -u train.py \
-save_model=${SAVED_DIR}${MODEL_NAME} \
-data=data/onmt_processed_data/full_dataset/full_dataset \
-vocab=data/onmt_processed_data/full_dataset/full_dataset \
-model_type=text \
-share_embeddings \
