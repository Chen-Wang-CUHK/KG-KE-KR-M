...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    translator = Translator(opt, model_opt, model, fields, global_scorer=scorer,
                            out_file=out_file, scores_out_file=scores_out_file,
                            sel_probs_out_file=sel_probs_out_file,
                            report_score=report_score, copy_attn=model_opt.copy_attn,
...
class Translator(object):
    ...
    Args:
       ...
       out_file(string): the file to store the generated keyphrase candidates
       scores_out_file(string): the file to store the generation score of each generated candidate
       sel_probs_out_file(string): the file to store the predicted importance scores of each source text token
    """
