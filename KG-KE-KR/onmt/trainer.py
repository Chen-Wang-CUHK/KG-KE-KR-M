...
class Trainer(object):
    ...
    Args:
            key_model(string): the string represents the model type
            model(:py:class:`onmt.models.model.E2EModel`): translation model
                to train
            train_loss(:obj:`onmt.utils.loss.E2ELossCompute`):
               training loss computation
            valid_loss(:obj:`onmt.utils.loss.E2ELossCompute`):
               training loss computation
            ...
            report_manager(:obj:`onmt.utils.MyReportMgr`):
                the object that creates reports, or None
            model_saver(:obj:`onmt.models.ModelSaverBase`): the saver is
                used to save a checkpoint.
                Thus nothing will be saved if this parameter is None
            stop_nodecrease_steps(int): If the PPL does not decrease such number of steps, the training stops.
    """
