...
class TextDataset(DatasetBase):
    ...
    def __init__(self, fields, src_examples_iter, posi_neg_indicators_iter, tgt_examples_iter,
        ...
        if posi_neg_indicators_iter is not None:
            examples_iter = (self._join_dicts(src, indicators, tgt) for src, indicators, tgt in
                             zip(src_examples_iter, posi_neg_indicators_iter, tgt_examples_iter))
        else:
    ...
    def make_text_examples_nfeats_tpl(text_iter, text_path, truncate, side):
        ...
        """
        assert side in ['src', 'tgt', 'posi_neg_indicator']
    ...
    def get_fields(n_src_features, n_tgt_features):
        ...
        # add for reranker
        fields["posi_neg_indicators"] = torchtext.data.Field(
            pad_token=PAD_WORD,
            unk_token=None)
