...
def build_dataset(fields, data_type, src_data_iter=None, src_path=None,
                  posi_neg_indicator=None, posi_neg_indicator_path=None,
    ...
    posi_neg_indicator_examples_iter, num_posi_neg_indicator_feats = \
        TextDataset.make_text_examples_nfeats_tpl(
            posi_neg_indicator, posi_neg_indicator_path, src_seq_length_trunc, "posi_neg_indicator")
    ...
    if data_type == 'text':
        # (self, fields, src_examples_iter, key_indicators_iter, tgt_examples_iter,
        #  num_src_feats=0, num_tgt_feats=0,
        #  src_seq_length=0, tgt_seq_length=0,
        #  dynamic_dict=True, use_filter_pred=True)
        dataset = TextDataset(fields, src_examples_iter, posi_neg_indicator_examples_iter, tgt_examples_iter,
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text':
        ...
        # add for KE
        _build_field_vocab(fields["posi_neg_indicators"], counter["posi_neg_indicators"],
                           max_size=3,
                           min_freq=1)
        logger.info(" * posi_neg_indicators vocab size: %d." % len(fields["posi_neg_indicators"].vocab))
        ...
        # Merge the src and tgt vocabularies.
        if share_vocab:
