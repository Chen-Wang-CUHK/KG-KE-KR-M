...
class GlobalAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    def __init__(self, dim, coverage=False, attn_type="dot", no_sftmax_bf_rescale=False):
...
class MyGlobalAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    def __init__(self, dim, coverage=False, attn_type="dot", not_use_sel_probs=False, no_sftmax_bf_rescale=False):
    ...
    def forward(self, source, memory_bank, probs, memory_lengths=None, coverage=None):
        """
        ...
        # compute attention scores, as in Luong et al.
        align = self.score(source, memory_bank) # [batch x tgt_len x src_len]
